...
def run_dht3(settings, threads, stop_event, callback=None, mqtt_publisher=None):
    if callback is None:
    ...
    if settings['simulated']:
        ...
        dht3_thread = threading.Thread(target=run_dht3_simulator, args=(2, enhanced_callback, stop_event))
        dht3_thread.start()
